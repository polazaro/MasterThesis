...
dest_path = 'C:/Users/ruben/Documents/Máster Data Science/2º Cuatrimestre/Master Thesis/Database/IEMOCAP_audio_2_training_100_RNN/'
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['hap/'+file+'.wav' for file in files_list]
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['sad/'+file+'.wav' for file in files_list]
                files_list = files_list[::2] # Because we are only going to use every second (1 de cada dos)
                files_list = [file.replace(' ','').replace("'",'') for file in files_list]
                for i in range(0, len(files_list)-(seq_len-1)):
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['neu/'+file+'.wav' for file in files_list]
                files_list = files_list[::2] # Because we are only going to use every second (1 de cada dos)
                files_list = [file.replace(' ','').replace("'",'') for file in files_list]
                for i in range(0, len(files_list)-(seq_len-1)):
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['ang/'+file+'.wav' for file in files_list]
                files_list = files_list[::2] # Because we are only going to use every second (1 de cada dos)
                files_list = [file.replace(' ','').replace("'",'') for file in files_list]
                for i in range(0, len(files_list)-(seq_len-1)):
...
#df_val.to_csv(dest_path + 'val_seqs.csv', index=False)
#df_test.to_csv(dest_path + 'test_seqs.csv', index=False)
