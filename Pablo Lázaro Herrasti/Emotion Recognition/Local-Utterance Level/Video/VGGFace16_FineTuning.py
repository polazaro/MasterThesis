...
train = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_faces_2_training/4Labels/training_4labels_flip.csv')
val = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_faces_2_training/4Labels/validation_4labels_flip.csv')
im_size = 224
batch_size = 32
nb_class = 4
n_epochs = 30
...
for layer in custom_vgg_model.layers[:-14]:
...
custom_vgg_model.compile(optimizer=adam, loss='categorical_crossentropy', metrics=['acc'])
