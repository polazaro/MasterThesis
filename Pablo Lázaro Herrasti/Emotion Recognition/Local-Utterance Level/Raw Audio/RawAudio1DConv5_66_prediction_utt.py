...
training, validation and test sets. Audio: 66ms.
...
train = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_training_66/4Labels/training_4labels.csv')
val = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_training_66/4Labels/validation_4labels.csv')
test = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_training_66/4Labels/test_4labels.csv')
...
seq_train = AudioDataSequence(train, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_training_66/4Labels/train/',  
                           batch_size = batch_size, nb_class = nb_class, mode = 'train')
seq_val = AudioDataSequence(val, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_training_66/4Labels/validation/',  
                         batch_size = batch_size, nb_class = nb_class, mode = 'val')
seq_test = AudioDataSequence(test, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_training_66/4Labels/test/',  
                         batch_size = batch_size, nb_class = nb_class, mode = 'val')

'''Predicting with the loaded model'''

print('Files')
path_model = '/app/Audio2/Experiment1_66/weights.000026-0.422-1.234-0.414-1.255.h5'
loaded_model = load_model(path_model)

print('Loaded model')

predictions = loaded_model.predict_generator(generator = seq_train)
