...
dest_path = 'C:/Users/ruben/Documents/Máster Data Science/2º Cuatrimestre/Master Thesis/Database/IEMOCAP_audio_2_features_100_RNN/'
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['hap/'+file+'.csv' for file in files_list]
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['sad/'+file+'.csv' for file in files_list]
                files_list = files_list[::2] # Because we are only going to use every second (1 de cada dos)
                files_list = [file.replace(' ','').replace("'",'') for file in files_list]
                for i in range(0, len(files_list)-(seq_len-1)):
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['neu/'+file+'.csv' for file in files_list]
                files_list = files_list[::2] # Because we are only going to use every second (1 de cada dos)
                files_list = [file.replace(' ','').replace("'",'') for file in files_list]
                for i in range(0, len(files_list)-(seq_len-1)):
    ...
    for item in raw_data:
        if ':' in item:
            ...
            if len(files_list) < 20:
                ...
                files_list = ['ang/'+file+'.csv' for file in files_list]
                files_list = files_list[::2] # Because we are only going to use every second (1 de cada dos)
                files_list = [file.replace(' ','').replace("'",'') for file in files_list]
                for i in range(0, len(files_list)-(seq_len-1)):
