...
Script to load the best raw audio model and obtain the accuracy on the
train, validation or test sets. Audio: 100ms.
...
train = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_100/4Labels/training_4labels.csv')
val = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_100/4Labels/validation_4labels.csv')
test = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_100/4Labels/test_4labels.csv')
...
seq_train = FeatDataSequence(train, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_100/4Labels/train/',  
                           batch_size = batch_size, nb_class = nb_class, mode = 'train')
seq_val = FeatDataSequence(val, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_100/4Labels/validation/',  
                         batch_size = batch_size, nb_class = nb_class, mode = 'val')
seq_test = FeatDataSequence(test, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_100/4Labels/test/',  
                         batch_size = batch_size, nb_class = nb_class, mode = 'val')

'''Predicting with the loaded model'''

print('Files')
path_model = '/app/AudioFeatures2/Experiment1_100_1/weights.000026-0.403-1.253-0.428-1.228.h5'
