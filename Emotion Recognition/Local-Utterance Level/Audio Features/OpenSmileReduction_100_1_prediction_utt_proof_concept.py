...
F1_talking = pd.read_csv('/app/data/ProofConcept/Features/F1_feat.csv')
F2_talking = pd.read_csv('/app/data/ProofConcept/Features/F2_feat.csv')
...
seq_F1 = FeatDataSequence(F1_talking, '/app/data/ProofConcept/Features/',  
                         batch_size = batch_size, nb_class = nb_class)
seq_F2 = FeatDataSequence(F2_talking, '/app/data/ProofConcept/Features/',  
                         batch_size = batch_size, nb_class = nb_class)
...
preds_F1_df.to_csv('/app/data/ProofConcept/Features/'+'local_preds_F1.csv', index=False)
preds_F1_utt_df = pd.DataFrame(pred_labels_utt, columns=['true','mean','majority vote'])
preds_F1_utt_df.to_csv('/app/data/ProofConcept/Features/'+'utt_preds_F1.csv', index=False)
...
preds_F2_df.to_csv('/app/data/ProofConcept/Features/'+'local_preds_F2.csv', index=False)
preds_F2_utt_df = pd.DataFrame(pred_labels_utt, columns=['true','mean','majority vote'])
preds_F2_utt_df.to_csv('/app/data/ProofConcept/Features/'+'utt_preds_F2.csv', index=False)
