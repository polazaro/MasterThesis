...
test = pd.read_csv('/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_66/4Labels/test_4labels.csv')
...
seq_test = FeatDataSequence(test, '/app/data/IEMOCAP_dat1/IEMOCAP_audio_2_features_66/4Labels/test/',  
                         batch_size = batch_size, nb_class = nb_class, mode = 'val')

'''Predicting with the loaded model'''

print('Files')
path_model = '/app/AudioFeatures2/Experiment1_66_1/weights.000026-0.405-1.251-0.421-1.236.h5'
